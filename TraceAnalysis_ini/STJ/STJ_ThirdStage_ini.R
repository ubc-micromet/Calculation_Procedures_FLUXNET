...
#Run Intermediary Code to reformat data
#source("Database_FLUXNET/Calculation_Procedures/TraceAnalysis_ini/STJ/Clean_FLUXNET.R")
...
tv_input <- "TIMESTAMP_START"

# Specify site location
lat <- 	39.0882 # Site latitude
long <- -75.4372 # Site longitude
TimeZoneHour <- -4 # time offset (in PST) from UTC 
